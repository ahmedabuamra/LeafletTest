...
var configtext = "" + fs.readFileSync("/home/aboamra/Downloads/postGISConnection.js");
...
app.get('/', function (req, res) {
  ...
  pool.connect(function (err, client, done) {
    ...
    var querystring = "select * from information_schema";
    client.query(querystring, null, function (err, result) {
      console.log("ay 5ara");
      done();
      if (err) {
        console.log(err);
